  ...
  return (
    <span
      ...
      className={cn(
        ...
        // Shine effect
        "animate-shiny-text bg-size-[var(--shiny-width)_100%] bg-position-[0_0] bg-clip-text bg-no-repeat [transition:background-position_1s_cubic-bezier(.6,.6,0,1)_infinite]",
